...
function ResumeEditor(props) {
    ...
    return <div className="editor-container">
        ...
        {props.body ? props.body.map((m, ind) => {
            return <ResumeEditorSection ind={ind} displaySubsec={displaySectionInd === ind} setSection={setSection} key={m.key} map={m} onChange={props.onChangeBody} delete={props.deleteMap} revert={props.revertBody} save={props.saveBody}/>
        }) : null}
